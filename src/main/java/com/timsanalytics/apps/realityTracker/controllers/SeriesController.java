...
import com.timsanalytics.apps.realityTracker.services.SeriesService;
...
public class SeriesController {
    ...
    public ResponseEntity<Series> getSeriesDetail(@Parameter(description = "Series GUID", required = true) @PathVariable String seriesGuid) {
        try {
