...
import com.timsanalytics.apps.realityTracker.competition.beans.PickResult;
...
public class ProjectedScoringService {
    ...
    @Autowired
    public ProjectedScoringService(PickResultService pickResultService, CompetitionPlayerService competitionPlayerService, RoundService roundService) {
