...
public class PersonController {
    ...
    public ResponseEntity<ServerSidePaginationResponse> getPersonList_SSP(@RequestBody ServerSidePaginationRequest serverSidePaginationRequest) {
        long startTime = new Date().getTime();
        try {
            ServerSidePaginationResponse container = this.personService.getPersonList_SSP(serverSidePaginationRequest);
    ...
    public ResponseEntity<ServerSidePaginationResponse> getPersonFriendList_SSP(@RequestBody ServerSidePaginationRequest serverSidePaginationRequest) {
        long startTime = new Date().getTime();
        try {
