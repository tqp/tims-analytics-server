...
public class ScoringService {
    ...
    @Autowired
    public ScoringService(PickResultService pickResultService, PlayerService playerService, com.timsanalytics.main.realityTracker.competition.services.RoundService roundService) {
