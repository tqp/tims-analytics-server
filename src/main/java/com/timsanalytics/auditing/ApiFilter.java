...
//                String token = requestWrapper.getHeader("Authorization").replaceFirst("Bearer ", "");
//                System.out.println("Username: " + getUsernameFromToken(token));
//            }

//            // Get Response tme, if requestStartTime is present
//            if (requestWrapper.getAttribute("requestStartTime") != null) {
//                long time = System.currentTimeMillis() - ((Long) request.getAttribute("requestStartTime"));
